    ...
    return (
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
                <div className="bg-gray-100 p-6 rounded-lg">
                    ...
                    <h4 className="text-lg text-gray-900 font-medium title-font mb-1">{props.title}</h4>
                    <h3 className="tracking-widest text-gray text-xs font-medium title-font mb-2">Total Calories: {props.calories} cal</h3>
