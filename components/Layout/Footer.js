    ...
    return (
      ...
      <div className="container px-5 pt-8 pb-4 mx-auto flex items-center justify-end sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          <a
            ...
            href="https://twitter.com/anshuulllll"
            target="_blank"
            rel="noopener"
            aria-label="Twitter"
          >
          ...
          <a
            className="ml-3 text-gray-500  dark:text-gray-200 color-transition"
            href="https://www.instagram.com/anshuuulllll/"
            target="_blank"
            rel="noopener"
          ...
          <a
            className="ml-3 text-gray-500  dark:text-gray-200 color-transition"
            href="https://www.linkedin.com/in/anshultated99/"
            target="_blank"
            rel="noopener"
      ...
      <Image
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
          This website uses the Edamam API but is not endorsed or certified by
          Edamam.
        </p>
      </div>
    </footer>
