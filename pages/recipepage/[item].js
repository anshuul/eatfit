                      ...
                      <div className="flex flex-col sm:flex-row mt-10">
                        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                          <div className="flex flex-col items-center text-center justify-center">
                            <h2 className="font-bold title-font mt-4 text-gray-900 dark:text-gray-100 text-xl">{recipe.title}</h2>
                            <div className="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
                            <h3 className="tracking-widest text-gray font-medium font-body text-sm mb-2 dark:text-gray-100">Total Calories: {recipe.calories} cal</h3>
                          </div>
                        </div>
                        <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0">
                        <h2 className="font-bold title-font mt-4 text-gray-900 dark:text-gray-100 text-xl">Ingredients:</h2>
                          <ol className="list-decimal mt-5 ml-4 dark:text-gray-100 text-gray-900">
